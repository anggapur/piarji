              ...
              <form method="POST" action="{{url('tandaTanganSetting/saveData')}}" enctype="multipart/form-data">
                ...
                <div class="col-md-4">    
                  ...
                  <div class="form-group">    
                    <label>Jabatan</label>
                    <input type="text" name="data[1][1][nilai1]" class="form-control" placeholder="Jabatan" value="{{collect($dataTTD)->firstWhere('bagian','1')->nilai1}}" required>
                  </div>
                  <div class="form-group">    
                    <label>Nama</label>
                    <input type="text" name="data[1][1][nilai2]" class="form-control" placeholder="Nama" value="{{collect($dataTTD)->firstWhere('bagian','1')->nilai2}}" required>
                  </div>
                  <div class="form-group">    
                    <label>Pangkat</label>
                    <input type="text" name="data[1][1][nilai3]" class="form-control" placeholder="Pangkat" value="{{collect($dataTTD)->firstWhere('bagian','1')->nilai3}}" required>
                  </div>
                  <div class="form-group">
                    <label>TTD</label>
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">    
                    ...
                    <input type="text" name="data[1][2][nilai4]" class="form-control" placeholder="Mengetahui" value="{{collect($dataTTD)->firstWhere('bagian','2')->nilai4}}" required>
                  </div>                     
                  <div class="form-group">    
                    <label>Jabatan</label>
                    <input type="text" name="data[1][2][nilai1]" class="form-control" placeholder="Jabatan" value="{{collect($dataTTD)->firstWhere('bagian','2')->nilai1}}" required>
                  </div>
                  <div class="form-group">    
                    <label>Nama</label>
                    <input type="text" name="data[1][2][nilai2]" class="form-control" placeholder="Nama" value="{{collect($dataTTD)->firstWhere('bagian','2')->nilai2}}" required>
                  </div>
                  <div class="form-group">    
                    <label>Pangkat</label>
                    <input type="text" name="data[1][2][nilai3]" class="form-control" placeholder="Pangkat" value="{{collect($dataTTD)->firstWhere('bagian','2')->nilai3}}" required>
                  </div>
                   <div class="form-group">
                    <label>TTD</label>
                ...
                <div class="col-md-4">     
                  ...
                  <div class="form-group">    
                    <label>Waktu</label>
                    <input type="text" name="data[1][3][nilai4]" class="form-control" placeholder="Waktu" value="{{collect($dataTTD)->firstWhere('bagian','3')->nilai4}}" required>
                  </div>                     
                  <div class="form-group">    
                    <label>Jabatan</label>
                    <input type="text" name="data[1][3][nilai1]" class="form-control" placeholder="Jabatan" value="{{collect($dataTTD)->firstWhere('bagian','3')->nilai1}}" required>
                  </div>
                  <div class="form-group">    
                    <label>Nama</label>
                    <input type="text" name="data[1][3][nilai2]" class="form-control" placeholder="Nama" value="{{collect($dataTTD)->firstWhere('bagian','3')->nilai2}}" required>
                  </div>
                  <div class="form-group">    
                    <label>Pangkat</label>
                    <input type="text" name="data[1][3][nilai3]" class="form-control" placeholder="Pangkat" value="{{collect($dataTTD)->firstWhere('bagian','3')->nilai3}}" required>
                  </div>
                   <div class="form-group">
                    <label>TTD</label>
                    <input type="file" name="image3" class="form-control">
                      <div class="wrapTTD">
                        ...
                        <span><i class="fa fa-trash deleteImage" data-id="{{collect($dataTTD)->firstWhere('bagian','3')->id}}"></i></span>
                        
                       <img src="{{url('public/images').'/'.collect($dataTTD)->firstWhere('bagian','3')->image}}" class="img-responsive" alt="Tidak Ada Gambar" data-id="{{collect($dataTTD)->firstWhere('bagian','3')->id}}">
                       @endif
                      </div>
                  </div>
                </div>
