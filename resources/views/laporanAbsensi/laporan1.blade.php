              ...
              <div id="printArea" class="printArea" style="display: none;">
               ...
               <div class="TTDarea row"> 
                ...
                <div class="TTD2 col-cs-4">
                   <div class="nilai4">{{collect($dataTTD)->firstWhere('bagian','2')->nilai4}}</div>
                  <div class="nilai1">
                ...
                <div class="TTD3 col-cs-4">
                   <div class="nilai4 tglSpace">{{collect($dataTTD)->firstWhere('bagian','3')->nilai4}}</div>
                  <div class="nilai1">
          ...
          $.ajax({
                ...
                success: function(data) {
                  ...
                  else if(data.status == "success")
                  {
                    ...
                    singleDataExport.push({"text":"PPH 21 "});
