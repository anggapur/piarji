        ...
        <div class="col-lg-12 col-xs-12">         
          ...
          <div class="box box-info noprint" >
            ...
            <div class="box-header">              
              <!-- <h3 class="box-title">Laporan Rekap Absensi Tunkin Induk</h3>                             -->
            </div>
            <div class="box-body">    
            ...
            <div class="box-body"> 
              ...
              <div class="judulLaporan">
                <h5 class="judul">
                REKAPITULASI PENERIMAAN TUNJANGAN KINERJA <span class="keanggotaan"> </span> <br>POLDA BALI<br>T.A <span class="tahun"></span>
                </h5>
                ...
                success: function(data) {
                  ...
                  iteration = 1;
                   $.each(data.satker,function(k,v){ 
                    ...
                    pengembalianTot = data.amprahan[v.kd_satker] - (realisasi-jumlahPengurangan) - moneyPPH;
