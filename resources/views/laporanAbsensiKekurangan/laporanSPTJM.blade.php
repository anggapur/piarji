          ...
          $.ajax({
                ...
                success: function(data) {
                  ...
                  else if(data.status == "success")
                  {
                    ...
                    $('.sprinJumlah').html("Rp "+number_format(sprinJumlah,2,",","."));
                    $('.sisaSprint').html("Rp "+number_format(sisaSprint,2,",","."));
                  ...
                  mengenaiWord = data.words;                    
                    ...
                    insertWord = insertWord.replace('[nominalAngka]',"Rp "+number_format(Math.ceil(jml12),2,",","."));
