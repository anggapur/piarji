              ...
              <div class="box-body">
                <div class="printLaporan" style="display: none;">
                    ...
                    <div class="judulLaporan">
                      <h5 class="judul">
                      REKAPITULASI DAFTAR PEMBAYARAN TUNJANGAN KINERJA SUSULAN ANGGOTA <span class="keanggotaan"></span>
                      </h5>
   ...
   <script type="text/javascript">
      //form bulan tahun
        $('#formBulanTahun').submit(function(e){ 
          ...
          $.ajax({
                type: "POST",                  
                url: "{{route('pilihBulanTahunLaporanBSusulan')}}",
                data: 
                { 
                  "_token": "{{ csrf_token() }}",
                  "bulan" : bulan,
                ...
                success: function(data) {
                   $('span.satkerNama').html(data.selectedSatker.nm_satker);
                  $('h5.satkerNama').html("SATKER : "+data.selectedSatker.nm_satker);
                  console.log(data);
