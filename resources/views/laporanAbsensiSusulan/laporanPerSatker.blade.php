        ...
        <div class="col-lg-12 col-xs-12">         
          ...
          <div class="box box-info noprint" >
            ...
            <div class="box-header">              
              <!-- <h3 class="box-title">Laporan Rekap Absensi Tunkin Susulan</h3>                             -->
            </div>
            <div class="box-body">    
            ...
            <div class="box-body"> 
              ...
              <div class="judulLaporan">
                <h5 class="judul">
                REKAPITULASI PENERIMAAN TUNJANGAN KINERJA SUSULAN <span class="keanggotaan"> </span> <br>POLDA BALI<br>T.A <span class="tahun"></span>
                </h5>
